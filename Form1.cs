...
namespace WallHavenDesktop
{
    public partial class Form1 : Form
    {
        ...
        {
            textBox1.Text = timeTrackBar.Value.ToString();
            ...
            refreshTimer.Interval = timeTrackBar.Value * 60000;
        ...
        private void timeTrackBar_Scroll(object sender, EventArgs e)
        {
            ...
            {
                refreshTimer.Interval = timeTrackBar.Value * 1000;
            }
        }
        ...
        {
                Random r = new Random();
                Uri link = new Uri("https://wallpapers.wallhaven.cc/wallpapers/full/wallhaven-"+r.Next(0,435265)+".jpg");
